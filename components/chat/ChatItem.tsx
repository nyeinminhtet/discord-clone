...
import { ShieldCheck, Crown, FileIcon, Edit, Trash } from "lucide-react";
...
const ChatItem = ({
  ...
  return (
    <div
      className="relative group flex items-center hover:bg-black/5 p-4
                 transition w-full"
    >
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md overflow-hidden mt-2
